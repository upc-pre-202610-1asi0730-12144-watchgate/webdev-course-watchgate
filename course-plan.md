...
**Herramientas necesarias:** Acceso a un navegador web ya sea (Chrome, Firefox, Safari, Edge).

**Repositorio de Código Fuente:** [https://github.com/upc-pre-202610-1asi0730-12144-watchgate/webdev-course-watchgate.git](https://github.com/upc-pre-202610-1asi0730-12144-watchgate/webdev-course-watchgate.git)

## 📁 Estructura del Repositorio

Para facilitar tu aprendizaje, este proyecto está dividido en dos directorios principales:

* 📂 **`starter-files/`**: Contiene los archivos base iniciales. Aquí es donde escribirás tu código siguiendo cada lección.
